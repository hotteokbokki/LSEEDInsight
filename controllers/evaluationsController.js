        ...
        if (period === "quarterly") {
            ...
            query = `
                ...
                SELECT 
                    ...
                    y.avg_rating,
                    'yearly' AS period
                FROM YearlyRatings y
                JOIN TopSEsYearly t ON y.se_id = t.se_id
                ORDER BY t.weighted_avg_rating DESC, y.social_enterprise, y.month;
            `;
            ...
            throw new Error("Invalid period specified. Use 'trimester' or 'yearly'.");
        }
